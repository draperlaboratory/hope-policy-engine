...
const std::map<std::string, uint8_t> LLVMMetadataTagger::metadata_ops = {
...
const std::map<std::string, uint8_t> LLVMMetadataTagger::tag_specifiers = {
...
const std::map<std::string, std::map<std::string, std::string>> LLVMMetadataTagger::policy_map = {
  {"call-tgt", {
...
bool LLVMMetadataTagger::policy_needs_tag(const YAML::Node& policy_inits, const std::string& tag) {
...
void LLVMMetadataTagger::check_and_write_range(RangeFile& range_file, uint64_t start, uint64_t end, uint8_t tag_specifier, const YAML::Node& policy_inits, RangeMap& range_map) {
