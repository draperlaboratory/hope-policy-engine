...
void ideal_pipe_t::install_rule(operands_t *ops, results_t *res) {
  //operands_t *ops_copy = new operands_t{new meta_set_t{*ops->pc}, new meta_set_t{*ops->ci}, new meta_set_t{*ops->op1}, new meta_set_t{*ops->op2}, new meta_set_t{*ops->op3}, new meta_set_t{*ops->mem}};
  ...
  results_t *res_copy = new results_t{new meta_set_t{*res->pc}, new meta_set_t{*res->rd}, new meta_set_t{*res->csr}, res->pcResult, res->rdResult, res->csrResult};
